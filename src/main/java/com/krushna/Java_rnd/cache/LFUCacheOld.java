...
public class LFUCacheOld<K, V> {
    ...
    public LFUCacheOld(int capacity) {
    ...
    public static void main(String[] args) {
        LFUCacheOld<Integer, String> cache = new LFUCacheOld<>(3);
        cache.put(1, "A");
        cache.put(2, "B");
        cache.put(3, "C");
        ...
        cache.put(1, "A");
        cache.put(5, "A");
        System.out.println(cache.cacheMap); // Expect key 1, 4, and one of 2/3
    }
}
